    ...
    class Subject
      ...
      def subject_in_form
        if self.subject.needs_article?
          MarkovGrammar::Article.join_with_matching(article, self.subject.base_form_or_synonym)
        else
      ...
      def subject_in_form_with_adjective
        ...
        if self.subject.needs_article?
          MarkovGrammar::Article.join_with_matching(article, "#{adjective} #{self.subject.base_form_or_synonym}")
        else
